...
cp -a --verbose ${REPO_ROOT}/compositeArtifacts${LABEL}.jar ${REPO_ROOT}/compositeArtifacts.jar
RC=$?
if [[ $RC != 0 ]]
then
...
cp -a --verbose ${REPO_ROOT}/compositeContent${LABEL}.jar   ${REPO_ROOT}/compositeContent.jar
RC=$?
if [[ $RC != 0 ]]
then
